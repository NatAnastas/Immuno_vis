...
These are examples of a tables containing the necessary informations for diversity estimation visualizations. The tables includes mock data specifically generated for this purpose.
...
Heatmap(
  ...
  draw(merge_legends = TRUE, background = "#d9e3f1")
